...
#[test]
fn hostile_custom_dimensions_are_refused_before_allocation() {
    // A 36-byte fuzz artefact (r459) declaring a custom 8191x8191
    // picture: the driver refuses it through the picture-area guard
    // instead of allocating gigabytes of band buffers.
    use oxideav_indeo::indeo5::{DecodeError, MAX_PICTURE_PIXELS};
    let hostile: [u8; 36] = [
        0x1f, 0x43, 0xe1, 0xbc, 0xbe, 0xe0, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0a, 0xff,
        0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x31, 0x1f, 0x02, 0x44, 0x00, 0x43, 0x1f, 0x43, 0x00,
        0x00, 0x00, 0x00, 0x3f, 0x00, 0x0f,
    ];
    assert!(matches!(
        decode_intra_picture(&hostile),
        Err(DecodeError::PictureTooLarge {
            width: 8191,
            height: 8191
        })
    ));
    assert!(u64::from(320u32) * 240 < MAX_PICTURE_PIXELS);
}

#[test]
fn hostile_multi_level_geometry_recomposes_without_panic() {
    // A fuzz artefact (r459): a picture whose plane size is not a
    // multiple of `2^levels`, so the recomposed inner low-low band and
    // the next level's ceil-sized triple differ by one sample; the
    // recompose fits them instead of asserting.
    let hostile: &[u8] = &[
        0x1f, 0x3a, 0x00, 0x7a, 0x09, 0x00, 0x4f, 0x00, 0x18, 0x08, 0xc0, 0x7e, 0x00, 0x00, 0x40,
        0x00, 0xec, 0x47, 0x4c, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3,
        0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3,
        0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3,
        0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3,
        0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3,
        0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xb3, 0xff, 0x01, 0xda,
        0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
        0x00,
    ];
    let _ = decode_intra_picture(hostile);
}
